...
expName = 'Data Window Experiment'  # from the Builder filename that created this script
...
# Setup the Window
win = visual.Window(
    size=(1350, 700), fullscr=False, screen=0,
...
text_instructions23 = visual.TextStim(win=win, name='text_instructions23',
    text=u"-> Attribute xxx \u2194 Attribute yyy (please, mark in only one cell)\n    Extremely xxx \u2013 Moderately xxx \u2013 Slightly xxx \u2013 Neutral - Slightly yyy\n    Moderately yyy \u2013 Extremely yyy\n-> Please, after selecting your choice press the 'accept?' button to confirm your alternative.",
    font='Arial',
    pos=(-0.01, -0.37), height=0.059, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-2.0);
rating = visual.RatingScale(win=win, name='rating', marker=u'triangle', size=0.9, pos=[0.0, -0.7], low=1, high=7, labels=[u'Hard', u' Soft'], scale=u'Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False, acceptPreText='Do not Forget me')
...
text_instructions31 = visual.TextStim(win=win, name='text_instructions31',
    text='\nThese are the 13 scales that are going to be used to evaluate the sound stimuli\n\n                                                    * Hard <-> Soft\n                                                    * Colorless <-> Colorful\n                                                    * Dull <-> Sharp\n                                                    * Heavy <-> Light\n                                                    * Complex <-> Simple\n                                                    * Cold <-> Warm\n                                                    * Dim <-> Bright\n                                                    * Mixed <-> Pure\n                                                    * Strong <-> Weak\n                                                    * Full <-> Empty\n                                                    * Rough <-> Smooth\n                                                    * Thick <-> Thin\n                                                    * Scattered <-> Compact',
    font='Arial',
    pos=(-0.1, 0.59), height=0.047, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-4.0);
...
exposure_text = visual.TextStim(win=win, name='exposure_text',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0);
rating_2 = visual.RatingScale(win=win, name='rating_2', marker='triangle', size=0.7, pos=[-0.7, 0.7], low=1, high=7, labels=['Hard', 'Soft'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_3 = visual.RatingScale(win=win, name='rating_3', marker='triangle', size=0.7, pos=[-0.7, 0.3], low=1, high=7, labels=['Colorless', ' Colorful'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_4 = visual.RatingScale(win=win, name='rating_4', marker='triangle', size=0.7, pos=[-0.7, -0.1], low=1, high=7, labels=['Dull', ' Sharp'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_5 = visual.RatingScale(win=win, name='rating_5', marker='triangle', size=0.7, pos=[-0.7, -0.5], low=1, high=7, labels=['Heayv', ' Light'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_6 = visual.RatingScale(win=win, name='rating_6', marker='triangle', size=0.7, pos=[0.0, 0.8], low=1, high=7, labels=['Complex', ' Simple'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_7 = visual.RatingScale(win=win, name='rating_7', marker='triangle', size=0.7, pos=[0.0, 0.4], low=1, high=7, labels=['Cold', ' Warm'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_8 = visual.RatingScale(win=win, name='rating_8', marker='triangle', size=0.7, pos=[0.0, 0.0], low=1, high=7, labels=['Dim', ' Bright'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_9 = visual.RatingScale(win=win, name='rating_9', marker='triangle', size=0.7, pos=[0.0, -0.4], low=1, high=7, labels=['Mixed', ' Pure'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_10 = visual.RatingScale(win=win, name='rating_10', marker='triangle', size=0.7, pos=[0.0, -0.79], low=1, high=7, labels=['Strong', ' Weak'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_11 = visual.RatingScale(win=win, name='rating_11', marker='triangle', size=0.7, pos=[0.7, 0.7], low=1, high=7, labels=['Full', ' Empty'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_12 = visual.RatingScale(win=win, name='rating_12', marker='triangle', size=0.7, pos=[0.7, 0.3], low=1, high=7, labels=['Rough', ' Smooth'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_13 = visual.RatingScale(win=win, name='rating_13', marker='triangle', size=0.7, pos=[0.7, -0.1], low=1, high=7, labels=['Thick', ' Thin'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
rating_14 = visual.RatingScale(win=win, name='rating_14', marker='triangle', size=0.7, pos=[0.7, -0.5], low=1, high=7, labels=['Scattered', ' Compact'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
...
listening_hard_soft = visual.RatingScale(win=win, name='listening_hard_soft', marker='triangle', size=0.7, pos=[-0.7, 0.7], low=1, high=7, labels=['Hard', 'Soft'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_colorless_Colorful = visual.RatingScale(win=win, name='listening_colorless_Colorful', marker='triangle', size=0.7, pos=[-0.7, 0.3], low=1, high=7, labels=['Colorless', 'Colorful'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_dull_dharp = visual.RatingScale(win=win, name='listening_dull_dharp', marker='triangle', size=0.7, pos=[-0.7, -0.1], low=1, high=7, labels=['Dull', 'Sharp'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_heavy_light = visual.RatingScale(win=win, name='listening_heavy_light', marker='triangle', size=0.7, pos=[-0.7, -0.5], low=1, high=7, labels=['Heavy', 'Light'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_complex_simple = visual.RatingScale(win=win, name='listening_complex_simple', marker='triangle', size=0.7, pos=[0.0, 0.8], low=1, high=7, labels=['Complex', 'Simple'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_cold_warm = visual.RatingScale(win=win, name='listening_cold_warm', marker='triangle', size=0.7, pos=[0.0, 0.4], low=1, high=7, labels=['Cold', 'Warm'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_dim_bright = visual.RatingScale(win=win, name='listening_dim_bright', marker='triangle', size=0.7, pos=[0.0, 0.0], low=1, high=7, labels=['Dim', 'Bright'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_mixed_pure = visual.RatingScale(win=win, name='listening_mixed_pure', marker='triangle', size=0.7, pos=[0.0, -0.4], low=1, high=7, labels=['Mixed', 'Pure'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_strong_weak = visual.RatingScale(win=win, name='listening_strong_weak', marker='triangle', size=0.7, pos=[0.0, -0.79], low=1, high=7, labels=['Strong', 'Weak'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_full_empty = visual.RatingScale(win=win, name='listening_full_empty', marker='triangle', size=0.7, pos=[0.7, 0.7], low=1, high=7, labels=['Full', 'Empty'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_rough_smooth = visual.RatingScale(win=win, name='listening_rough_smooth', marker='triangle', size=0.7, pos=[0.7, 0.3], low=1, high=7, labels=['Rough', 'Smooth'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_thick_thin = visual.RatingScale(win=win, name='listening_thick_thin', marker='triangle', size=0.7, pos=[0.7, -0.1], low=1, high=7, labels=['Thick', 'Thin'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
listening_scattered_compact = visual.RatingScale(win=win, name='listening_scattered_compact', marker='triangle', size=0.7, pos=[0.7, -0.5], low=1, high=7, labels=['Scattered', 'Compact'], scale='Extr.  Mod.  Sli. Neutral  Sli.  Mod.  Extr',showValue=False,acceptPreText='Do not Forget me')
...
# keep track of which components have finished
exposureComponents = [exposure_sound, exposure_text, rating_2, rating_3, rating_4, rating_5, rating_6, rating_7, rating_8, rating_9, rating_10, rating_11, rating_12, rating_13, rating_14, exposure_continue, exposure_mouse, play_again_exposure]
...
for thisListening_trial in listening_trials:
    ...
    # keep track of which components have finished
    listening_expComponents = [listening_sound, listening_hard_soft, listening_colorless_Colorful, listening_dull_dharp, listening_heavy_light, listening_complex_simple, listening_cold_warm, listening_dim_bright, listening_mixed_pure, listening_strong_weak, listening_full_empty, listening_rough_smooth, listening_thick_thin, listening_scattered_compact, listening_count, listening_continue, listening_mouse, listening_play_again_continue]
    ...
    while continueRoutine:
        ...
        # *listening_heavy_light* updates
        if t >= 0.0 and listening_heavy_light.status == NOT_STARTED:
            # keep track of start time/frame for later
            listening_heavy_light.tStart = t
            listening_heavy_light.frameNStart = frameN  # exact frame index
            listening_heavy_light.setAutoDraw(True)
...
#            p_sound.play()
    ...
    # store data for listening_trials (TrialHandler)
    listening_trials.addData('listening_heavy_light.response', listening_heavy_light.getRating())
    # store data for listening_trials (TrialHandler)
